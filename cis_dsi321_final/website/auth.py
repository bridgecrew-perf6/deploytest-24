...
flow = Flow.from_client_secrets_file(
    ...
    redirect_uri="https://7194-2001-fb1-c9-212f-906-8c2c-94ed-bf65.ap.ngrok.io/callback"
)
...
def search():
    ...
    with con:
        ...
        query1= "select * from Company where Company_Type LIKE '{}%' order by Company_ID".format(post_searched)
        cur.execute(query1)
        row= cur.fetchall()
...
api.add_resource(companyapi,"/login")   